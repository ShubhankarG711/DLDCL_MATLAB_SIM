function [xi_EST] = DCLKF_phi(N, G, rbt_ID, xj_Act, xj_IMU, xTg, mu_dx,IMU_cov,mu_cov)
% Kalman Fusion method for fusing multiple yaw angle estimates
l_N = 1:N;
